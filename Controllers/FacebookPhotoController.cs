            ...
            var RequiredPermissions =
                ...
                { "publish_actions", 
                    new FacebookPermissionRequest { 
                        name = "Posting", 
                        description = "Provides the Tech4m with ability to create new albums and photos.", 
                        permision_scope_value = "publish_actions", 
                        requested = false } },
                { "user_photos", 
                    new FacebookPermissionRequest { 
                        name = "Photo Access", 
                        description = "Provides the Tech4m with ability to view and create albums and photos.", 
