    ...
    public class FacebookPostController : BaseController
    {
        ...
        protected override Dictionary<string, FacebookPermissionRequest> GetRequiredPermissions()
        {
            ...
            ("publish_actions",
                    ...
                    {
                        name = "Posting",
                        description = "Provides the Tech4m with ability to add a new post to your Facebook news feed, page feed, event feed or group feed.",
            ...
            ("user_friends",
                    new FacebookPermissionRequest
                    {
                        ...
                        description = "Provides the Tech4m with ability to present a listing of your Friends to select for tagging with your post.",
