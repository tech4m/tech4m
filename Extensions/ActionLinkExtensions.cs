...
namespace tech4mUI.Extensions
{
    public static class ActionLinkExtensions
    {
        ...
        public static MvcHtmlString CategoryLink(this HtmlHelper helper, SubCategory category)
        {
            return helper.ActionLink(category.SubCategoryName, "Category", "Blog", new { category = category.UrlSlug }, new { title = String.Format("See all posts in {0}", category.SubCategoryName) });
