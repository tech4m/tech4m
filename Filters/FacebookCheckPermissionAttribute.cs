...
namespace tech4mUI.Filters
{
    public class FacebookCheckPermission : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            PermissionRequestViewModel permissionViewModel = 
                myBaseController.GetMissingPermissions();
                ...
                permissionViewModel.MissingPermissions.Count > 0)
            {
                ...
                filterContext.Result = myBaseController
                    .FB_RequestPermission(permissionViewModel);
                return;
            }
            #endregion
